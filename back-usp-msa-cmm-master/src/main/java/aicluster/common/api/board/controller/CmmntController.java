...
public class CmmntController {
	 ...
	 */
	@GetMapping("")
	public CorePagination<CmmtBoardCmmnt> getList(@PathVariable String boardId, @PathVariable String articleId, Boolean latest, Long page, Long itemsPerPage) {
	 ...
	 */
	@PostMapping("")
	public CmmtBoardCmmnt add(@PathVariable String boardId, @PathVariable String articleId, String cmmnt) {
	 ...
	 */
	@PutMapping("{cmmntId}")
	public CmmtBoardCmmnt modify(@PathVariable String boardId, @PathVariable String articleId, @PathVariable String cmmntId, String cmmnt) {
