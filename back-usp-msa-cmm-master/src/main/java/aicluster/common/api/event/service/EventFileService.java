...
public class EventFileService {
	...
	public JsonList<CmmtAttachment> getList(String eventId) {
		...
		List<CmmtAttachment> list = attachmentService.getFileInfos_group(cmmtEvent.getAttachmentGroupId());
	...
	public void downloadAttFile(HttpServletResponse response, String eventId, String attachmentId) {
		...
		CmmtAttachment attachment = attachmentService.getFileInfo(attachmentId);
		if (attachment == null) {
