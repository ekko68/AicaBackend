...
public class TermsController {
	...
	public JsonList<CmmtTermsListItem> getDayList(@PathVariable String termsType, @RequestParam String srchCd) {
	...
	public JsonList<CmmtTerms> getToday(@PathVariable String termsType) {
