...
public class RoleService {
	...
	@Autowired
	private CmmtAuthorityDao authorityDao;
	@Autowired
	private CmmtProgramDao programDao;
	@Autowired
...
//		}
	...
	public void delete(String roleId)
	{
		...
		// 역할-권한 매핑 검증
		List<CmmtAuthorityRole> authorityRoleList = authorityDao.selectByRoleId(roleId);
		...
		// 역할-프로그램 매핑 검증
		List<CmmtProgramRole> programRoleList = programDao.selectByRoleId(roleId);
