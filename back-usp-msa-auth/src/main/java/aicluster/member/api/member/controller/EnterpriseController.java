...
public class EnterpriseController {
	 ...
	 */
	@PostMapping("")
	public CmmtEnt add(@RequestBody(required = false) EnterpriseParam enterParam) {
	 ...
	 */
	@PutMapping("")
	public CmmtEnt modify(@RequestBody(required = false) EnterpriseParam enterParam) {
	 ...
	 */
	@GetMapping("/{memberId}")
	public CmmtEnt getMemberEnt(@PathVariable String memberId) {
