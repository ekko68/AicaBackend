...
public class InsiderController {
	 ...
	 */
	@PostMapping("")
	public CmmtInsider add(@RequestBody(required = false) InsiderMemberDto dto) {
		CmmtInsider cmmtInsider = insiderService.addInsider(dto);
		return cmmtInsider;
	}
	 ...
	 */
	@GetMapping("/{memberId}")
	public CmmtInsider get(@PathVariable String memberId) {
		CmmtInsider cmmtInsider = insiderService.getInsider(memberId);
		return cmmtInsider;
	}
	 ...
	 */
	@PutMapping("/{memberId}")
	public CmmtInsider modify(@PathVariable String memberId, @RequestBody(required = false) InsiderMemberDto dto) {
		dto.setMemberId(memberId);
		CmmtInsider cmmtInsider = insiderService.modifyInsider(dto);
		return cmmtInsider;
	}
