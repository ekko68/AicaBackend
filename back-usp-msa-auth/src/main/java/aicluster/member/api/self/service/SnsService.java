...
public class SnsService {
	...
	public void google(SnsLoginParam param) {
		...
		CmmtMember googleUser = cmmtMemberDao.selectByGoogleToken(googleId);
		if (googleUser != null) {
	...
	public void naver(SnsLoginParam param) {
		...
		CmmtMember naverUser = cmmtMemberDao.selectByNaverToken(naverId);
		if (naverUser != null) {
	...
	public void kakao(KakaoLoginParam param) {
		...
		CmmtMember kakaoUser = cmmtMemberDao.selectByKakaoToken(kakaoId);
		if (kakaoUser != null) {
