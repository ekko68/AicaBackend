...
import aicluster.batch.common.dao.CmmtHldyDao;
...
public class HolidayService {
    ...
    private List<HolidayItem> getHolidayList(String solYear, String solMonth) {
    	...
    	HttpResponse<String> res = Unirest.get(url)
    			.queryString("serviceKey", publicDataConfig.getServiceKey() + "1")
    ...
    public int updateHolidays(int beginYear, int beginMonth, int monthCnt) {
    	...
    	String year = null;
    	String month = null;
    	List<CmmtHldy> holidayList = new ArrayList<>();
    	List<HolidayItem> holidayItemList = null;
    	CmmtHldy cmmtHldy = null;
    	Date dt = null;
    	int totalItems = 0;
