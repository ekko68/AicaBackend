...
public class FrontSlctnObjcController {
	...
	public void getObjcAtchmnfl(HttpServletResponse response, @PathVariable("objcReqstId") String objcReqstId) {
		frontSlctnObjcService.getObjcAtchmnfl(response, objcReqstId);
	}
	...
	public void getDlbrtAtchmnfl(HttpServletResponse response, @PathVariable("objcReqstId") String objcReqstId) {
		frontSlctnObjcService.getDlbrtAtchmnfl(response, objcReqstId);
	}
