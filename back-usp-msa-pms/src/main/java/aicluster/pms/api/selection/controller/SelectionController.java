...
public class SelectionController {
	...
	public JsonList<LastSelectionDto> modifyLastSelection(@PathVariable("evlLastSlctnId") String evlLastSlctnId, @RequestBody List<LastSelectionParam> lastSelectionList) {
		return selectionService.modifyLastSelection(evlLastSlctnId, lastSelectionList);
	}
