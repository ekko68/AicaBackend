...
public class SlctnPblancController {
	...
	public ModelAndView getListExcelDwld(SlctnPblancListParam slctnPblancListParam){
		...
		sheet.setProperties("ntce", "bsnsYear", "bsnsNm", "pblancNm", "ordtmRcrit", "chrgDeptNm", "pblancDay", "regDt");
	...
	public void download(HttpServletResponse response, @PathVariable("pblancId") String slctnPblancId) {
