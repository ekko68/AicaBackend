...
public class EntrpsSttusController {
	...
	public ModelAndView getListExcelDwld(HttpServletRequest request, EntrpsSttusListParam entrpsSttusListParam){
		...
		sheet.setProperties("bsnsYear", "bsnsNm", "pblancNm", "taskType", "taskNmKo", "entrpsNm", "bizrno", "partcptnDiv", "rspnberNm", "mbtlnum", "email", "recentSendDate");
		sheet.setTitle("업체현황");
	...
	public void sendMsg(@RequestBody EntrpsSttusSendParam param) {
		entrpsSttusSerivce.sendMsg(param);
	}
