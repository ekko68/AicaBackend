...
public class FrontBsnsApplyParam implements Serializable{
	...
	/** 체크리스트 */
	private List<UsptBsnsPblancApplyChklst> chkList;
	/** 과제 참여인력 */
	private List<UsptBsnsPblancApplyTaskPartcpts> taskPartcptsList;
	/** 파일 업로드 목록 */
	private List<UsptBsnsPblancApplyAttach> uploadFileList;
}
