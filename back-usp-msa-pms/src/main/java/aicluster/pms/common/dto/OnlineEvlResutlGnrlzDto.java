...
@AllArgsConstructor
@NoArgsConstructor
public class OnlineEvlResutlGnrlzDto implements Serializable {

	private static final long serialVersionUID = 2067029518192100416L;
	...
	List<EvlIemByCmitDto> evlIemByCmitDtoList; /*평가항목리스트*/
}
