...
public class EntrpsSttusListDto implements Serializable {
	...
	public String getMbtlnum() {
		...
		String mobileNo = aes256.decrypt(this.encMbtlnum, this.applyId);
		return mobileNo;
	}

	/** 마스킹 이메일 */
	public String getMaskingEmail() {
		if(CoreUtils.string.isBlank(this.getEmail())) {
			return "";
		}
		return CoreUtils.masking.maskingEmail(this.getEmail());
	}
	/** 마스킹 휴대폰번호 */
