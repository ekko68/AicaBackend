...
import aicluster.framework.common.dao.FwAuthorityDao;
...
public class CustomUserDetailsService implements UserDetailsService {
	...
	@Autowired
    private FwMemberDao memberDao;

	@Autowired
	private FwInsiderDao insiderDao;

	@Autowired
	private FwUsptEvlMfcmmDao evaluatorDao;

	@Autowired
    private FwAuthorityDao authorityDao;

    @Override
    public UserDetails loadUserByUsername(String username) throws UsernameNotFoundException {
    	BnMember member = null;
    	if (string.startsWith(username, "member:")) {
