...
import aicluster.framework.common.dao.CmmtSessionDao;
import aicluster.framework.common.entity.CmmtSession;
...
public class SessionAuthUtils {
	...
	public class PasswdCheck {
		...
		public String set(String memberId) {
			...
			CmmtSession session = CmmtSession.builder()
					.sessionId(sessionId)
		...
		public String get(String sessionId) {
			CmmtSession session = dao.select(sessionId);
			if (session == null) {
