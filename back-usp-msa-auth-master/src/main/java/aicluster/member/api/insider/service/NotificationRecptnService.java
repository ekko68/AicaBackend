...
import aicluster.member.common.dao.CmmtSystemPicDao;
...
public class NotificationRecptnService {
	 ...
	 */
	public JsonList<CmmtSystemPic> getList()
	{
	 ...
	 * @return 오류알림 수신담당자 목록
	 */
	public JsonList<CmmtSystemPic> insertList(NotificaionRecptnParam param)
	{
		SecurityUtils.checkWorkerIsInsider();
		...
		List<CmmtSystemPic> insertList = new ArrayList<>();
		...
		int i = 0;
		for (CmmtSystemPic insertItem : param.getList()) {
			// API시스템ID 입력 검증
