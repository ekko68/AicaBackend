...
public class MemberController {
	 ...
	 */
	@GetMapping("/{memberId}")
	public CmmtMember get(@PathVariable  String memberId) {
	 ...
	 */
	@PutMapping("/{memberId}")
	public CmmtMember modify(@PathVariable String memberId,@RequestBody(required = false) MemberParam param) {
	...
	public CmmtMember black(@PathVariable String memberId,@RequestBody(required = false) BlackListDto blackListDto) {
	...
	public CmmtMember unblack(@PathVariable String memberId) {
	...
	public JsonList<CmmtMemberHist> getHistList(@PathVariable String memberId) {
