...
//@Slf4j
public class CmmtInsiderDaoTest extends TestDaoSupport {
	@Autowired
	private CmmtInsiderDao dao;

	private CmmtInsider cmmtInsider;
	...
	public void test() {
		...
		// select
		CmmtInsider m1 = dao.select(cmmtInsider.getMemberId());
