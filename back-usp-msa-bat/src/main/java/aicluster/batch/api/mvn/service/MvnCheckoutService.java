...
import aicluster.batch.common.dao.UsptCheckoutHistDao;
import aicluster.batch.common.dao.UsptCheckoutReqDao;
import aicluster.batch.common.dao.UsptMvnCompanyDao;
import aicluster.batch.common.dao.UsptMvnFcDao;
...
public class MvnCheckoutService {
	...
	@Autowired
	private UsptCheckoutReqDao checkoutDao;

	@Autowired
	private UsptCheckoutHistDao checkoutHistDao;

	@Autowired
	private UsptMvnCompanyDao mvnCmpnyDao;

	@Autowired
	private UsptMvnFcDao mvnFcDao;
	...
	public int updateCheckout()
	{
		...
		List<UsptCheckoutReq> checkoutList = checkoutDao.selectList_mvnCheckoutYn();

		List<UsptCheckoutHist> histList = new ArrayList<>();
		for (UsptCheckoutReq checkoutReq : checkoutList) {
    		UsptMvnCompany mvnCompany = mvnCmpnyDao.select(checkoutReq.getMvnId());
    		UsptMvnFc mvnFc = mvnFcDao.select(mvnCompany.getMvnFcId());
            ...
            // 퇴실처리 이력을 남긴다.
        	UsptCheckoutHist hist = UsptCheckoutHist.builder()
