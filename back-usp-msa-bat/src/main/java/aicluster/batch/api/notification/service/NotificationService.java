...
import aicluster.batch.common.dao.CmmtSystemPicDao;
...
public class NotificationService {
	...
	@Autowired
	private CmmtSystemPicDao cmmtSystemPicDao;
	...
	public long notifyError() {
		...
		// 담당자 조회
		List<CmmtSystemPic> picList = cmmtSystemPicDao.selectAll();
	...
	private int sendErrorEmail(String emailCn, List<CmmtSystemPic> picList, Map<String, String> templateParam) {
		Date now = new Date();
