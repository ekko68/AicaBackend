...
<%!
     ...
     *  Web-Agent 환경 설정   (** 수정)
     ************************************************************/
/**/private static final String AUTH_URL = "http://dev-sso.atops.or.kr";     // ISign+ SSO URL
...
/**/private static final String requestData = "id";       // 요청 데이터(세션에 저장될 값)
    ...
    private static final String OAUTH_LOGIN_PROCESS = AUTH_URL + "/authentication/oauth/loginProcess";
