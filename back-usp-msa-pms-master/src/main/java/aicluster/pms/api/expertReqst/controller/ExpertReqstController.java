...
public class ExpertReqstController {
	...
	public ModelAndView getExpertReqstListExcel(ExpertReqstListParam expertReqstListParam){
		...
		sheet.setProperties("rn"	, "expertNm"	,"expertReqstProcessSttusCd"	, "nativeNm"	, "wrcNm"	, "ofcpsNm"	, "mbtlnum"	, "email"	, "brthdy");
	 ...
	 */
	@GetMapping("/{expertId}")
	public ExpertReqstDto getExpertReqstInfo(@PathVariable("expertId") String expertId) {
		log.debug("#####	getExpertReqstInfo : {}", expertId);
		return expertReqstService.getExpertReqstInfo(expertId);
	}
