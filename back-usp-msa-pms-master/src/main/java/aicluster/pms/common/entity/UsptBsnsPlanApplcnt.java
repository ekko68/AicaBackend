...
public class UsptBsnsPlanApplcnt implements Serializable {
	 ...
	 * @return
	 */
	public String getDeChargerMbtlnum() {
		if (string.isBlank(this.chargerMbtlnum)) {
			return null;
		}
		return aes256.decrypt(this.chargerMbtlnum, this.bsnsPlanApplcntId);
	}
	 ...
	 * @return
	 */
	public String getDeChargerEmail() {
		if (string.isBlank(this.chargerEmail)) {
			return null;
		}
		return aes256.decrypt(this.chargerEmail, this.bsnsPlanApplcntId);
	}
}
