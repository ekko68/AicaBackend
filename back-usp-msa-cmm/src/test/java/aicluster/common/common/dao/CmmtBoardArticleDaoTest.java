...
//@Slf4j
public class CmmtBoardArticleDaoTest extends TestDaoSupport {
	@Autowired
	private CmmtBoardDao boardDao;

	@Autowired
	private CmmtBoardArticleDao articleDao;

	private CmmtBoard board;
	private CmmtBoardArticle article1;
	private CmmtBoardArticle article2;
	private CmmtBoardArticle article3;

	@BeforeEach
	public void init() {
		Date now = new Date();

		board = CmmtBoard.builder()
				.boardId("testboard-")
				.systemId("portal")
				.boardNm("test")
				.articleCnt(0L)
		...
		article1 = CmmtBoardArticle.builder()
		...
		article2 = CmmtBoardArticle.builder()
		...
		article3 = CmmtBoardArticle.builder()
	...
	public void test() {
		...
		CmmtBoardArticle a1 = articleDao.select(article1.getArticleId());
