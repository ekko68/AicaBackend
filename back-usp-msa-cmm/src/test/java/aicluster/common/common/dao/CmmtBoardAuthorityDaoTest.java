...
//@Slf4j
public class CmmtBoardAuthorityDaoTest extends TestDaoSupport {
	@Autowired
	private CmmtBoardDao boardDao;
	@Autowired
	private CmmtBoardAuthorityDao baDao;
	...
	public void test() {
		...
		// insertList()
		List<CmmtBoardAuthority> list = new ArrayList<>();
		...
		baDao.save(ba);
		CmmtBoardAuthority ba2 = baDao.select(ba.getBoardId(), ba.getAuthorityId());
