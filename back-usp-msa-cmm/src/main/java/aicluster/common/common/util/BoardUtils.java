...
public class BoardUtils {
	 ...
	 * @param exs
	 */
	public void checkCmmtBoard(CmmtBoard board, InvalidationsException exs) {
		// boardId 검사
	 ...
	 * @return
	 */
	public boolean canReadArticle(CmmtBoard cmmtBoard, BnMember worker) {
		/*
		...
		CmmtBoardAuthority cmmtBoardAuthority = cmmtBoardAuthorityDao.select(cmmtBoard.getBoardId(), worker.getAuthorityId());
	...
	public boolean canWriteArticle(String boardId, BnMember worker) {
		...
		CmmtBoardAuthority cmmtBoardAuthority = cmmtBoardAuthorityDao.select(boardId, worker.getAuthorityId());
		if (cmmtBoardAuthority == null) {
			return false;
		}
	 ...
	 * @return
	 */
	public boolean canModifyArticle(String boardId, CmmtBoardArticle cmmtBoardArticle, BnMember worker) {
		/*
	 ...
	 * @return
	 */
	public boolean canRemoveArticle(String boardId, CmmtBoardArticle cmmtBoardArticle, BnMember worker) {
		/*
