...
public class HolidayController {
	 ...
	 */
	@PostMapping("")
	public CmmtHldy add(@RequestBody(required = false) CmmtHldy holiday) {
	 ...
	 */
	@GetMapping("/{ymd}")
	public CmmtHldy get(@PathVariable String ymd) {
	 ...
	 */
	@PutMapping("/{ymd}")
	public CmmtHldy modify(@PathVariable String ymd, @RequestBody(required = false) CmmtHldy holiday) {
		holiday.setYmd(ymd);
