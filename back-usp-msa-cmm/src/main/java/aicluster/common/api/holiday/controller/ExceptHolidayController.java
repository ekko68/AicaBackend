...
public class ExceptHolidayController {
	 ...
	 */
	@PostMapping("")
	public CmmtHldyExcl add(@RequestBody(required = false) CmmtHldyExcl exctHoliday) {
	 ...
	 */
	@GetMapping("/{ymd}")
	public CmmtHldyExcl get(@PathVariable String ymd) {
	 ...
	 */
	@PutMapping("/{ymd}")
	public CmmtHldyExcl modify(@PathVariable String ymd, @RequestBody(required = false) CmmtHldyExcl exctHoliday) {
