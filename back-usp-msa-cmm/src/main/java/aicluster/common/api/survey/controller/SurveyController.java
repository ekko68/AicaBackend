...
public class SurveyController {
	 ...
	 */
	@GetMapping("")
	public CorePagination<CmmtSurvey> getList(SurveyListParam param, CorePaginationParam pageParam) {
	 ...
	 */
	@GetMapping("{surveyId}")
	public CmmtSurvey getSurvey(@PathVariable String surveyId) {
	 ...
	 */
	@PutMapping("{surveyId}")
	public CmmtSurvey modifySurvey(@PathVariable String surveyId, SurveyModifyParam param) {
		if (param == null) {
	...
	public JsonList<CmmtSurveyQuestion> getQuestions(@PathVariable String surveyId) {
	...
	public JsonList<CmmtSurveyQuestion> saveQuestions(@PathVariable String surveyId, @RequestBody QuestionSaveParam param) {
		if (param == null) {
			throw new InvalidationException("입력이 없습니다.");
		}
		param.setSurveyId(surveyId);
